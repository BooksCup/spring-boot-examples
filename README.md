...
[spring-boot整合kafka](https://github.com/BooksCup/spring-boot-examples/tree/master/spring-boot-kafka)  
[spring-boot整合mongodb](https://github.com/BooksCup/spring-boot-examples/tree/master/spring-boot-mongodb)  
[spring-boot整合netty](https://github.com/BooksCup/spring-boot-examples/tree/master/spring-boot-netty)  
